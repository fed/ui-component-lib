...
var img = new Image();img.src = 'data:image/svg+xml;base64,';
...
function Spinner(props) {
  return props.visible && React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('img', { src: img$1, className: 'Spinner__image', alt: 'Cargando' })
    )
  );
}
